...
if (isset($_GET['tid'])) {
    ...
    $teachers_id = mysqli_real_escape_string($conn, $_GET['tid']);
    $sql = "SELECT * FROM tbl_teacher WHERE user_id = '$teachers_id'";
...
<body <?php if ($ms == "1") {
    ...
    <form class="search-form" action="search.php" method="GET">
        <div class="input-group">
            <input type="text" name="keyword" class="form-control search-input" placeholder="Search Teachers..." required>
    ...
    <main class="page-content content-wrap">
        ...
        <div class="page-inner">
            <div class="page-title">
                <h3>Edit Teachers - <?php echo "$sdfname"; ?> <?php echo "$sdlname"; ?></h3>
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                        <form action="pages/update_teacher.php" method="POST">
                                            ...
                                            <input type="hidden" name="teachers_id" value="<?php echo "$teachers_id"; ?>">
