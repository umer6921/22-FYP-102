...
<body class="page-header-fixed" <?php if ($ms == "1") { print 'onload="myFunction()"'; } ?>>
    ...
    <div class="menu-wrap">
        <nav class="profile-menu">
            <div class="profile">
                ...
                ?>
                <span><?php echo "umer"; ?> <?php echo "$mylname"; ?></span>
            </div>
    ...
    <main class="page-content content-wrap">
        <div class="navbar">
            <div class="navbar-inner">
                ...
                <div class="logo-box">
                    <a href="./" class="logo-text"><img src="..\assets\images\logo.jpg" alt="" height="76" width="130"></span></a>
                </div>
