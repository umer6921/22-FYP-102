        ...
        <div class="page-sidebar sidebar">
            <div class="page-sidebar-inner slimscroll">
                ...
                <li ><a href="./" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span>
                    ...
                    <li class="active"><a href="teachers.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon glyphicon-user"></span>
                            <p>Teachers</p>
                        </a></li>
                                        ...
                                        <tbody>';
                                                            ...
                                                            while ($row = $result->fetch_assoc()) {
                                                                ...
                                                                if ($status == "1") {
                                                                    ...
                                                                    $stl = '<a href="pages/make_teacher_in.php?id=' . $row['user_id'] . '">Make Inactive</a>';
                                                                } else {
                                                                    $st = '<p class="text-danger">INACTIVE</p>';
                                                                    $stl = '<a href="pages/make_teacher_ac.php?id=' . $row['user_id'] . '">Make Active</a>';
                                                                }
                                                                print '
										       <tr>
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>' . $stl . '</li>
													<li><a href="edit-teacher.php?tid=' . $row['user_id'] . '">Edit Teacher</a></li>
													<li><a href="view-teacher.php?tid=' . $row['user_id'] . '">View Teacher</a></li>
                                                    <li><a'; ?> onclick = "return confirm('Drop <?php echo $row['first_name']; ?> ?')" <?php print ' href="pages/drop_teacher.php?id=' . $row['user_id'] . '">Drop Teacher</a></li>
                                                </ul>
                                            </div></td>
