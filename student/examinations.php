                                    ...
                                    <div class="panel-body">
                                        ...
                                        <tbody>';
                                           ...
                                           while($row = $result->fetch_assoc()) {
											   ...
											   $stl = '<a class="btn btn-success" href="take-assessment.php?id='.$row['exam_id'].'" style="margin:5px ">Take Assessment</a> <a class="btn btn-success" href="practice-take-assessment.php?id='.$row['exam_id'].'">Practice Assessment</a>';
											   }else{
