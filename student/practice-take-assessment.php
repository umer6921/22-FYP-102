...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM tbl_assessment_practice_records WHERE student_id = '$myid' AND exam_id = '$exam_id'";
    $result = $conn->query($sql);
                                ...
                                The exam is already expired.
                                 ...
                                 <div class="alert alert-success" role="alert">
                                  You are good to go.
									...
									'; ?>
                                                    <a onclick="return confirm('Are you sure you want to begin ?')" class="btn btn-success" href="practice_assessment.php">Retake Practice Assessment</a>
                                ...
                                You will be able to retake this exam on ' . $retake_date . '
                                 ...
                                 <div class="alert alert-success" role="alert">
                                  You are good to go.
									...
									'; ?>
                                            <a onclick="return confirm('Are you sure you want to begin ?')" class="btn btn-success" href="practice_assessment.php">Practice Assessment</a>
