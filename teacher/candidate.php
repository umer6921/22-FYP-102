    ...
    <div class="menu-wrap">
        <nav class="profile-menu">
            ...
            <div class="profile-menu-list">
                ...
                <a href="logout.php?rp=9422"><i class="fa fa-sign-out"></i><span>Logout</span></a>
            </div>
        </nav>
    ...
    <main class="page-content content-wrap">
        <div class="navbar">
            <div class="navbar-inner">
                ...
                <div class="logo-box">
                    <a href="./" class="logo-text"><span><img src="..\assets\images\logo.jpg" alt="" height="76" width="130"></span></a>
                </div>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-list" role="menu">
                                    ...
                                    <li role="presentation"><a href="logout.php?rp=9422"><i class="fa fa-sign-out m-r-xs"></i>Log out</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="logout.php?rp=9422" class="log-out waves-effect waves-button waves-classic">
        ...
        <div class="page-sidebar sidebar">
            <div class="page-sidebar-inner slimscroll">
                    ...
                    <div class="sidebar-profile">
                        <a href="javascript:void(0);" id="profile-menu-link">
                            ...
                            <div class="sidebar-profile-details">
                                <span><?php echo "$myfname"; ?> <?php echo "$mylname"; ?><br><small>OES Teacher</small></span>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <ul class="menu accordion-menu">
                    ...
                    <li class="active"><a href="candidate.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon glyphicon-user"></span>
                            <p>Candidate</p>
                        </a></li>
                    <li><a href="sendinvitations.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-book"></span>
                            <p>Send Invitation</p>
                        </a></li>
                    <li><a href="examinations.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-book"></span>
                            <p>Examinations</p>
                        </a></li>
                    <li><a href="questions.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-book"></span>
                            <p>Questions</p>
                        </a></li>
                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab">Candidate</a></li>
                                                <li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">Add Candidate</a></li>
                                            </ul>
                                            ...
                                            <div class="tab-content">
                                                <div role="tabpanel" class="tab-pane active fade in" id="tab5">
                                                    <div class="table-responsive">
                                                        ...
                                                        // $sql = "SELECT *
                                                        // FROM tbl_users
                                                        // WHERE tbl_users.category IN (
                                                        // SELECT category
                                                        // FROM tbl_users
                                                        // WHERE tbl_users.category = '{$mycategory}' AND role='teacher')";
                                                        ...
                                                        if ($result->num_rows > 0) : ?>
                                                            <table id="example" class="table table-bordered">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $result = _getObjectToArray($result);
                                                                    // Convert Object to array
                                                                    foreach ($result as $value) :
                                                                        $status = (int)$value['acc_stat'];
                                                                        if ((int) $status == 1) {
                                                                            $st = '<p class="text-success">ACTIVE</p>';
                                                                            $stl = '<a href="../teacher/pages/make_sd_in.php?id=' . $value['user_id'] . '">Make Inactive</a>';
                                                                        } else {
                                                                            $st = '<p class="text-danger">INACTIVE</p>';
                                                                            $stl = '<a href="pages/make_sd_ac.php?id=' . $value['user_id'] . '">Make Active</a>';
                                                                        }
                                                                    ?>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="btn-group" role="group">
                                                                                    ...
                                                                                    <ul class="dropdown-menu" role="menu">
                                                                                        <li><?= $stl; ?></li>
                                                                                        <li><a href="<?= '../teacher/pages/edit-candidate.php?sid=' . $value['user_id'] . '' ?>">Edit Candidate</a></li>
                                                                                        <li><a href="<?= '../teacher/pages/view-candidate.php?sid=' . $value['user_id'] . '' ?>">View Candidate</a></li>
                                                                                        <li><a href="<?= '../teacher/pages/drop-candidate.php?sid=' . $value['user_id'] . '' ?>">Drop Candidate</a></li>
                                                                                    </ul>
                                                                                </div>
                                                                            </td>
                                                                        </tr>
                                                ...
                                                <div role="tabpanel" class="tab-pane fade" id="tab6">
                                                    <form action="pages/add_candidate.php" method="POST">
