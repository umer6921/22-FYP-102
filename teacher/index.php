...
<head>
        ...
        <title>OES | Teacher Dashboard</title>
        ...
        <main class="page-content content-wrap">
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <li><a href="sendinvitations.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-book"></span><p>Send Invitation</p></a></li>
